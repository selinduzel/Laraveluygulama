...
@section('css')
  <link rel="stylesheet" href="{{ asset('adminn')}}/plugins/chartist/css/chartist.min.css">
  <link rel="stylesheet" href="{{ asset('adminn')}}/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">   
@endsection
@section('master')
...
@section('js')
      <!-- ChartistJS -->
      <script src="{{ asset('adminn')}}/plugins/chartist/js/chartist.min.js"></script>
      <script src="{{ asset('adminn')}}/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>
      <script src="{{ asset('adminn')}}/js/dashboard/dashboard-1.js"></script>
@endsection